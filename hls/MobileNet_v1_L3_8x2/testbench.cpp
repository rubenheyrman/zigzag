...
list<int>    layer_iterations  {8, 2, 2, 2, 16, 49, 2, 256};
list<string> layer_dimensions  {"K", "C", "K", "K", "C", "B", "K", "B"};

W_addr_type_L1 W_loop_bound_L1[nb_cnt] = {2, 2, 16, 49, 1};
...
I_addr_type_L1 I_loop_bound_L1[nb_cnt] = {2, 2, 16, 1, 1};
...
O_addr_type_L1 O_loop_bound_L1[nb_cnt] = {2, 2, 16, 1, 1};
