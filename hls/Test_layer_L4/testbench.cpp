...
list<int>    layer_iterations  {4, 4, 4, 12, 52, 2, 3, 3, 13};
list<string> layer_dimensions  {"K", "C", "K", "C", "B", "K", "C", "K", "B"};

W_addr_type_L1 W_loop_bound_L1[nb_cnt] = {4, 12, 52, 1, 1};
...
W_addr_type_L3 W_loop_bound_L3[nb_cnt] = {3, 3, 13, 1, 1};
...
I_addr_type_L1 I_loop_bound_L1[nb_cnt] = {4, 12, 1, 1, 1};
bool I_loop_relevancy_L1[nb_cnt]       = {0, 1, 1, 1, 1};
I_addr_type_L2 I_loop_bound_L2[nb_cnt] = {52, 2, 1, 1, 1};
bool I_loop_relevancy_L2[nb_cnt]       = {1, 0, 1, 1, 1};
I_addr_type_L3 I_loop_bound_L3[nb_cnt] = {3, 3, 1, 1, 1};
bool I_loop_relevancy_L3[nb_cnt]       = {1, 0, 1, 1, 1};
I_addr_type_L4 I_loop_bound_L4[nb_cnt] = {13, 1, 1, 1, 1};
bool I_loop_relevancy_L4[nb_cnt]       = {1, 1, 1, 1, 1};
list<bool> I_mapped_to_DRAM = {0, 0, 0, 0, 0, 0, 0, 0, 1};

O_addr_type_L1 O_loop_bound_L1[nb_cnt] = {4, 12, 1, 1, 1};
bool O_loop_relevancy_L1[nb_cnt]       = {1, 0, 1, 1, 1};
O_addr_type_L2 O_loop_bound_L2[nb_cnt] = {52, 2, 3, 1, 1};
bool O_loop_relevancy_L2[nb_cnt]       = {1, 1, 0, 1, 1};
O_addr_type_L3 O_loop_bound_L3[nb_cnt] = {3, 1, 1, 1, 1};
bool O_loop_relevancy_L3[nb_cnt]       = {1, 1, 1, 1, 1};
O_addr_type_L4 O_loop_bound_L4[nb_cnt] = {13, 1, 1, 1, 1};
