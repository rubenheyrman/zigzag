ifeq "$(CXX_HOME)" ""
CXX_HOME                                               := /esat/micas-data/software/Mentor/catapult_10.5c
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                               := gcc
...
ifeq "$(QuestaSIM_Path)" ""
QuestaSIM_Path                                         := /esat/micas-data/software/Mentor/questasim_2020.4/questasim/bin
...
OSCI_SYSTEMC_INCLUDE                                   := /esat/micas-data/software/Mentor/catapult_10.5c/shared/include
export OSCI_SYSTEMC_INCLUDE
endif
ifeq "$(OSCI_SYSTEMC_LIB)" ""
OSCI_SYSTEMC_LIB                                       := /esat/micas-data/software/Mentor/catapult_10.5c/shared/lib/$(CXX_OS)/$(CXX_TYPE)
...
LowPower_SWITCHING_ACTIVITY_TYPE                       := saif
...
ifeq "$(MODEL_TECH)" ""
MODEL_TECH                                             := /esat/micas-data/software/Mentor/questasim_2020.4/questasim/bin
export MODEL_TECH
endif
ifeq "$(INCL_DIRS)" ""
INCL_DIRS                                              := 
