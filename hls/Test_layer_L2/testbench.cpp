...
list<int>    layer_iterations  {4, 4, 2, 4, 2, 4, 64, 3};
list<string> layer_dimensions  {"K", "C", "K", "K", "C", "C", "B", "K"};

W_addr_type_L1 W_loop_bound_L1[nb_cnt] = {2, 4, 2, 4, 64};
bool W_loop_relevancy_L1[nb_cnt]       = {1, 1, 1, 1, 0};
W_addr_type_L2 W_loop_bound_L2[nb_cnt] = {3, 1, 1, 1, 1};
...
I_addr_type_L2 I_loop_bound_L2[nb_cnt] = {64, 3, 1, 1, 1};
...
I_addr_type_L4 I_loop_bound_L4[nb_cnt] = {1, 1, 1, 1, 1};
...
O_addr_type_L3 O_loop_bound_L3[nb_cnt] = {64, 3, 1, 1, 1};
bool O_loop_relevancy_L3[nb_cnt]       = {1, 1, 1, 1, 1};
O_addr_type_L4 O_loop_bound_L4[nb_cnt] = {1, 1, 1, 1, 1};
