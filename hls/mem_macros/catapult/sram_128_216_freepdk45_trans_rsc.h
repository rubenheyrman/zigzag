#ifndef __INCLUDED_sram_128_216_freepdk45_trans_rsc_H__
#define __INCLUDED_sram_128_216_freepdk45_trans_rsc_H__
...
template < 
  ...
  ,int ADDR_WIDTH
>
class sram_128_216_freepdk45_trans_rsc : public mc_wire_trans_rsc_base<128,256>
{
public:
  sc_in< bool >   clk0;
  sc_in< sc_logic >   csb0;
  ...
  typedef mc_wire_trans_rsc_base<128,256> base;
  MC_EXPOSE_NAMES_OF_BASE(base);

  SC_HAS_PROCESS( sram_128_216_freepdk45_trans_rsc );
  sram_128_216_freepdk45_trans_rsc(const sc_module_name& name, bool phase, double clk_skew_delay=0.0)
  ...
  virtual void start_of_simulation() {
    ...
    if (base::_holdtime > 0) {
      ...
      msg << "sram_128_216_freepdk45_trans_rsc CLASS_STARTUP - CLK_SKEW_DELAY = "
...
#endif // ifndef __INCLUDED_sram_128_216_freepdk45_trans_rsc_H__
