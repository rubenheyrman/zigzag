#ifndef __INCLUDED_sram_128_216_freepdk45_H__
#define __INCLUDED_sram_128_216_freepdk45_H__

// SystemC memory model of sram_128_216_freepdk45
// Generated by Catapult memory generator
// Generated by:   r0678912
// Generated date: Sun Jul 25 15:51:26 2021

// The following classes have been defined:
//     class sram_128_216_freepdk45 a 0 delay "structural" model of the RAM

//     class sram_128_216_freepdk45_model<TLM/SYN>::mem<T,size,TLM/SYN>
//         A memory model that can be instanced and used for simulation and synthesis

//     class sram_128_216_freepdk45_model<TLM/SYN>::port_0_port<T,size,TLM/SYN>
//         a model of an external port with read/write capability

//     class sram_128_216_freepdk45_model<TLM/SYN>::port_1_port<T,size,TLM/SYN>
//         a model of an external port with read/write capability
...
#pragma map_to_operator sram_128_216_freepdk45
template <
  int ram_id,
  int DATA_WIDTH,
  int ADDR_WIDTH>
class sram_128_216_freepdk45 : public sc_module
{
public:
  sc_in< bool >   clk0;
  sc_in< bool >   csb0;
  ...
  sc_signal<sc_lv<128> > mem[256];
#endif

  SC_CTOR(sram_128_216_freepdk45) :
    clk0("clk0")
    ,csb0("csb0")
    ,web0("web0")
    ,addr0("addr0")
...
class sram_128_216_freepdk45_model {
public:
#if defined(__SYNTHESIS__)
...
public:
  ...
  private:
    sram_128_216_freepdk45<0, data_width, addr_width> RAM;
    sc_signal< bool >  csb0;
    sc_signal< bool >  csb1;
  };
...
#endif // ifndef __INCLUDED_sram_128_216_freepdk45_H__
