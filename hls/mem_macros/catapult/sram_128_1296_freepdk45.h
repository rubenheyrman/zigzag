#ifndef __INCLUDED_sram_128_1296_freepdk45_H__
#define __INCLUDED_sram_128_1296_freepdk45_H__

// SystemC memory model of sram_128_1296_freepdk45
// Generated by Catapult memory generator
// Generated by:   r0678912
// Generated date: Fri Jul 23 16:40:11 2021

// The following classes have been defined:
//     class sram_128_1296_freepdk45 a 0 delay "structural" model of the RAM

//     class sram_128_1296_freepdk45_model<TLM/SYN>::mem<T,size,TLM/SYN>
//         A memory model that can be instanced and used for simulation and synthesis

//     class sram_128_1296_freepdk45_model<TLM/SYN>::port_0_port<T,size,TLM/SYN>
//         a model of an external port with read/write capability

//     class sram_128_1296_freepdk45_model<TLM/SYN>::port_1_port<T,size,TLM/SYN>
//         a model of an external port with read/write capability
...
#pragma map_to_operator sram_128_1296_freepdk45
template <
  int ram_id,
  int DATA_WIDTH,
  int ADDR_WIDTH>
class sram_128_1296_freepdk45 : public sc_module
{
public:
  sc_in< bool >   clk0;
  sc_in< bool >   csb0;
  ...
  sc_signal<sc_lv<128> > mem[1296];
#endif

  SC_CTOR(sram_128_1296_freepdk45) :
    clk0("clk0")
    ,csb0("csb0")
    ,web0("web0")
    ,addr0("addr0")
  ...
  void seq_proc_2() {
    ...
    int address;
    // write X
    if ((csb0==0) && (csb1==0) && (web1==0)) {
      vector_to_type( addr1.read(), false, &address );
#if !defined(NO_ASSERTS) && !defined(__SYNTHESIS__)
      assert( address>=0 && address <1296 );
#endif
      mem[address] = din1.read();
    }
...
class sram_128_1296_freepdk45_model {
public:
#if defined(__SYNTHESIS__)
...
private:
  ...
  public:
    port_1_local( const char *name)
      : reset_chk( name, "call reset()", "access this memory")
      , clock_chk( name, "bind the clock port", "access this memory")
      , web1(ccs_concat(name,"web1"))
      , addr1(ccs_concat(name,"addr1"))
      , din1(ccs_concat(name,"din1"))
    ...
    void reset() {
      ...
      din1.write(sc_dt::Log_0);
      reset_chk.ok();
    }

    sc_signal< bool > web1;
    sc_signal< sc_lv<addr_width> > addr1;
    sc_signal< sc_lv<data_width> > din1;
...
public:
  ...
  public:
      ...
      , gen_csb1_instance(ccs_concat(name,"gen_csb1"))
    {
      ...
      RAM.web1(port_1_port_instance.web1);
      RAM.addr1(port_1_port_instance.addr1);
      RAM.din1(port_1_port_instance.din1);
  ...
  private:
    sram_128_1296_freepdk45<0, data_width, addr_width> RAM;
    sc_signal< bool >  csb0;
    sc_signal< bool >  csb1;
  };
  ...
  public:
    ...
    void operator() (mem<T,size,SYN> &m) {
      web1(m.port_1_port_instance.web1);
      addr1(m.port_1_port_instance.addr1);
      din1(m.port_1_port_instance.din1);
...
#endif // ifndef __INCLUDED_sram_128_1296_freepdk45_H__
