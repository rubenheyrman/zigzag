...
//#pragma hls_design interface
  void CCS_BLOCK(run)(ac_channel<packedData<O_partial_type,mem_words_O_L1_in> > O_data_in[4][3],
                      ac_channel<packedData<O_partial_type,mem_words_O_L1_out> > O_data_out[4][3],
                      ac_channel<packedData<I_type,mem_words_I_L1_in> > I_data_in[4][3],
                      ac_channel<packedData<W_type,mem_words_W_L1_in> > W_data_in[4][3],
...
private:
  ...
  rf<nb_counters_L1, mem_size_word_O_L1, mem_size_word_I_L1, mem_size_word_W_L1,
