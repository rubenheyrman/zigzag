...
list<int>    layer_iterations  {4, 2, 4, 16, 49, 2, 2, 256};
list<string> layer_dimensions  {"K", "C", "K", "C", "B", "K", "K", "B"};

W_addr_type_L1 W_loop_bound_L1[nb_cnt] = {4, 16, 49, 1, 1};
bool W_loop_relevancy_L1[nb_cnt]       = {1, 1, 0, 1, 1};
W_addr_type_L2 W_loop_bound_L2[nb_cnt] = {2, 2, 256, 1, 1};
...
I_addr_type_L2 I_loop_bound_L2[nb_cnt] = {49, 2, 2, 1, 1};
bool I_loop_relevancy_L2[nb_cnt]       = {1, 0, 0, 1, 1};
...
list<bool> I_mapped_to_DRAM = {0, 0, 0, 0, 0, 0, 0, 1};

O_addr_type_L1 O_loop_bound_L1[nb_cnt] = {4, 16, 1, 1, 1};
bool O_loop_relevancy_L1[nb_cnt]       = {1, 0, 1, 1, 1};
O_addr_type_L2 O_loop_bound_L2[nb_cnt] = {49, 2, 1, 1, 1};
