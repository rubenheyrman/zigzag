...
const int precision_bit_W = 16;
const int precision_bit_I = 16;
...
typedef ac_fixed<precision_bit_W ,16,false> W_type; 
typedef ac_fixed<precision_bit_I ,16,false> I_type;
...
typedef uint16_t I_ref_type;
typedef uint16_t W_ref_type;

// min and max values of weight and input random values
const uint16_t inputMIN = 0; 
const uint16_t inputMAX = 255;

const uint16_t weightMIN = 0; 
const uint16_t weightMAX = 10;
