...
private:
  ...
  NoC_I_down<I_type, mem_words_I_L2_out, mem_words_I_L1_in, nb_col, nb_row> NoC_I_L2_L1;
  ...
  O_partial_type, O_addr_type_L1, I_type, I_addr_type_L1, W_type, W_addr_type_L1> PE[nb_col][nb_row];
};
