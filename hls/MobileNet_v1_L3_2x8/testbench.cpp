...
list<int>    layer_iterations  {2, 8, 16, 2, 2, 49, 2, 16, 16};
list<string> layer_dimensions  {"K", "C", "K", "C", "C", "B", "K", "B", "B"};

W_addr_type_L1 W_loop_bound_L1[nb_cnt] = {16, 2, 2, 49, 1};
bool W_loop_relevancy_L1[nb_cnt]       = {1, 1, 1, 0, 1};
W_addr_type_L2 W_loop_bound_L2[nb_cnt] = {2, 16, 16, 1, 1};
bool W_loop_relevancy_L2[nb_cnt]       = {1, 0, 0, 1, 1};
...
I_addr_type_L1 I_loop_bound_L1[nb_cnt] = {16, 2, 2, 1, 1};
...
I_addr_type_L4 I_loop_bound_L4[nb_cnt] = {16, 16, 1, 1, 1};
bool I_loop_relevancy_L4[nb_cnt]       = {1, 1, 1, 1, 1};
list<bool> I_mapped_to_DRAM = {0, 0, 0, 0, 0, 0, 0, 1, 1};

O_addr_type_L1 O_loop_bound_L1[nb_cnt] = {16, 2, 2, 1, 1};
...
O_addr_type_L4 O_loop_bound_L4[nb_cnt] = {16, 16, 1, 1, 1};
bool O_loop_relevancy_L4[nb_cnt]       = {1, 1, 1, 1, 1};
list<bool> O_mapped_to_DRAM = {0, 0, 0, 0, 0, 0, 0, 1, 1};
